...
RegisterNetEvent('QBCore:Server:OnPlayerLoaded', function()
	...
	logger.log({
		...
		event = 'Loaded',
		color = 'green',
		message = ('**%s** (%s) loaded into the server with character: %s %s (**%s**)'):format(GetPlayerName(source),
			player.PlayerData.license, player.PlayerData.charinfo.firstname, player.PlayerData.charinfo.lastname,
